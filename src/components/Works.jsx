    ...
    <div ref={cardRef}>
      ...
      >
        ...
        <div className="mt-5">
          ...
          {timeline ? (
            <p className="mt-1 text-secondary text-[13px]">{timeline}</p>
          ) : null}
    ...
    <>
      ...
      <div className="w-full flex">
        <p className="mt-3 text-secondary text-[17px] max-w-3xl leading-[30px]">
          Selected projects showcasing production-grade AI systems and full-stack development—from model training and evaluation to deployment and user-facing interfaces.
        </p>
      </div>
